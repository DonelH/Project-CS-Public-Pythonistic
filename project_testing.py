...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setGeometry(0,0, 2020, 1300)
        ...
        refresh.setFixedWidth(220)
        refresh.setFixedHeight(80)
        refresh.move(50,900)
...
#        card_image = QLabel("Image here", self)
#        card_image.setGeometry(400, 1000, 600,200)
